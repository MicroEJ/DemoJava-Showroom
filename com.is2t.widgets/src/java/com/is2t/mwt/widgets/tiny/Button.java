...
public class Button extends Label implements IButton {
	...
	public void select() {
		...
		notifyListener(0);
		((ActivableController) getRenderer()).activate(this);
	}
	...
	public boolean handleEvent(int event) {
		...
		int result = ((ActivableController) getRenderer()).handleEvent(this, event);
		switch (result) {
		case ActivableController.ACTIVATED:
				notifyListener(event);
			// fall down
		case ActivableController.HANDLED:
			return true;
		default:
			return false;
		}
