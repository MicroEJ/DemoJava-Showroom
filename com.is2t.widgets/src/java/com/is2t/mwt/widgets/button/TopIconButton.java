...
public class TopIconButton extends TopIconLabel implements IButton {

	protected Listener selectionListener;
	private boolean pressed;
	private boolean active;

	public TopIconButton(String text, int maxLineCount, Picto icon) {
		super(text, maxLineCount, icon);
		setEnabled(true);
	}

	public TopIconButton(String text, Picto icon) {
		super(text, icon);
		setEnabled(true);
	}
